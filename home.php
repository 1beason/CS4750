...
<span id=GMs>
    ...
    <div class="container" style="justify:center;">
        <center>
        <img src="https://upload.wikimedia.org/wikipedia/en/thumb/a/a2/National_Football_League_logo.svg/1200px-National_Football_League_logo.svg.png" style="max-height: 400px; max-width: 400px;" />
        </center>
</div>
...
<div class="container">
    <center>
        ...
        <a class="btn btn-sm" href="login.php" role="button" style="color:#35a8f0">Login</a>
</center>
</body>