<html>
  ...
  <style>
    ...
    <meta name="description" content="Update Coach">
...
<div class="container" style="text-align: center;">
    ...
    <div class="form-group">
        <div class="form-row">
            <div class = "col">
                <label for="coachToUpdate">Which coach would you like to update?</label>
                <input type="text" class="form-control" id= "coachToUpdate" name="coachToUpdate" placeholder="Enter coach name" required>
            </div>
        </div>
    </div>
    <div class="form-group">
